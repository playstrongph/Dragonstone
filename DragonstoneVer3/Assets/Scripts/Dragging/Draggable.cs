...
//DS
    ...
    void OnMouseDown()
    {
        if (da!=null && da.CanDrag)
        {
            ...
            {
                CardManager HeroCard = GetComponentInParent<CardManager>();
                HeroCard.GetComponent<Transform>().transform.position = new Vector3 (HeroCard.GetComponent<Transform>().transform.position.x, 
                HeroCard.GetComponent<Transform>().transform.position.y, -1f);
            }
        ...
        if(GetComponentInParent<CardManager>() != null)
            {
                CardManager HeroCard = GetComponentInParent<CardManager>();
                HeroCard.GetComponent<Transform>().transform.position = new Vector3 (HeroCard.GetComponent<Transform>().transform.position.x, 
                HeroCard.GetComponent<Transform>().transform.position.y, 0f);
            }
