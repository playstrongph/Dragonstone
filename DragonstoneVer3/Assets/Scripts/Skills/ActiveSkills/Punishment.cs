...
public class Punishment : SkillComponent
{
    ...
    {                  
       ...
       tree.AddCurrent(InflictPoisonCoroutine(Attacker, Target));
    ...
    IEnumerator InflictPoisonCoroutine(GameObject Attacker, GameObject Target)
    {
       int sleepCounter = 3;

        tree.AddCurrent(AddDebuff(Attacker, Target, BuffName.POISON, sleepCounter,tree));
